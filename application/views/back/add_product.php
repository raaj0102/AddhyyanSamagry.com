    ...
    <div id="wrapper">
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-12">
                    <h2>Add Product</h2>
                     <h2 style="color:violet"><?php if($this->input->get('pro')=='added')
                     {
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                ...
                <form role="form" action="ins-product" method="post" enctype="multipart/form-data">
                    <div class="ibox-content">
                        <div class="row">    
                            <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Product Name *</label><input type="text" name="pro_name" placeholder="Enter Product Name" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Available Stock *</label><input type="number" name="pro_qty" placeholder="Enter Quantity" "pro_qty" class="form-control" required>
                                    </div>
                                <div class="form-group">
                                    <label>Description</label><textarea type="number" name="desc" placeholder="Description Box" class="form-control"></textarea>
                                </div>
                                <div>
                                        <button class="btn btn-sm btn-primary m-t-n-xs center-block" type="submit"><strong>Add Product</strong></button>     
                                </div>
                            </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                             <label>MRP Price *</label><input type="number" name="Mprice" placeholder="Enter Price" class="form-control" required>
                                         </div>
                                         <div class="form-group">
                                             <label>Offer Price *</label><input type="number" name="Oprice1" placeholder="Enter Price" class="form-control" required>
                                         </div>
                                    <label>Select Category *</label>
                                    <select name="pcat" data-placeholder="choose a category" class="chosen-select" required>
                                        <option selected disabled>Select Category</option>    
                                        <?php foreach ($cat as $c): ?>
                                        <option value="<?=$c->cid?>"><?php echo $c->cat_name?></option>  
                                        <?php endforeach; ?>
                                    </select>
                                    <label>Tag</label>
                                    <select name="ptag" class="form-control">
                            ...
                            <div class="col-sm-4"> 
                              ...
                              <div class="form-group"><label>Product Photo *</label> <input type="file" name="pro_img" id="imgCat" class="form-control" required></div>
