                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Add Course</h3>
                                <form role="form" action="ins-cat" method="post" enctype="multipart/form-data">
                                    <div class="form-group"><label>Course Name</label><input type="text" name="cat_name" placeholder="Enter Course Name" class="form-control" required></div>
                                    <div class="form-group"><label>Course Photo</label> <input type="file" name="cat_img" id="imgCat" class="form-control"></div>
                                    <div>
