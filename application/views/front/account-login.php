  ...
  <body>
   <?php include 'layout/header.php';?>
    ...
    <div class="page-title">
      <div class="container">
        <div class="column">
          <h1> User Login / Register Account</h1>
        </div>
        <div class="column">
    ...
    <div class="container padding-bottom-3x mb-2">
      <div class="row">
        <div class="col-md-6">
            <form class="card" action="login-user" method="post">
            <div class="card-body">
                 <p style="color:orange"><?php if($this->input->get('register')=='yes')
                 {
...
<!--              <div class="row margin-bottom-1x">
              ...
              <div class="form-group input-group">
                  <input class="form-control" type="text" name="umail" placeholder="Email/phone" required><span class="input-group-addon"><i class="icon-mail"></i></span>
              </div>
              <div class="form-group input-group">
                  <input class="form-control" type="password" name="upass" placeholder="Password" required><span class="input-group-addon"><i class="icon-lock"></i></span>
              </div>
        ...
        <div class="col-md-6">
          <div class=""></div>
          <!--<h3 class="">No Account? User Registration </h3>-->
          <form class="row" style="border:1px solid rgba(0,0,0,0.125); border-radius:.30rem" action="registration-form" method="post">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input class="form-control" type="email" name="reg-email" required>
                 <small style="color:red"><?php if($this->input->get('auth')=='yes')
                 {
                    echo 'Email already axist...';
                 }?></small>
              </div>
            </div>
<!--            <div class="col-sm-6">
