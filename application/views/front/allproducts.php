...
<head>
    ...
    <div class="container padding-bottom-3x mb-1">
      ...
      <div class="shop-toolbar padding-bottom-1x mb-2">
        <div class="column">
          <div class="shop-view"><a class="grid-view active" href="#"><span></span><span></span><span></span></a><a class="list-view" href="all-products?cat=<?=$cl->cid;?>"><span></span><span></span><span></span></a></div>
        </div>
      </div>
      <!-- Products Grid-->
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="product-card mb-30">       
            ...
            <a class="product-thumb" href="single-product?pid=<?= $al->p_id?>"><img src="uploads/products/<?=$al->photo;?>" style="height:250px" alt="Product"></a>
            ...
            <div class="product-button-group">
                <button class="product-button btn-wishlist addingwish" id="<?= $al->p_id?>" style="width:50%"><i class="icon-heart"></i><span>Wishlist</span></button>
                <button class="product-button addtocart" style="width:50%" id="<?=$al->p_id?>" data-toast data-toast-type="success" data-toast-position="topRight" data-toast-icon="icon-check-circle" data-toast-title="Product" data-toast-message="successfuly added to cart!">
