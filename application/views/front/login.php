...
<!-- login -->
	<div class="login">
		<div class="container">
			...
			<p><a href="user-registration">Register Here</a> (Or) go back to <a href="homepage">Home<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
	</div>
<!-- //login -->
<!-- //footer -->
	...
	<div class="footer-botm">
			<div class="container">
				...
				<div class="payment-w3ls">	
					<img src="assets/user/images//card.png" alt=" " class="img-responsive">
				</div>
...
<script src="assets/user/js/minicart.min.js"></script>
<script>
	// Mini Cart
...
<!-- main slider-banner -->
<script src="assets/user/js/skdslider.min.js"></script>
<link href="assets/user/css/skdslider.css" rel="stylesheet">
<script type="text/javascript">
		jQuery(document).ready(function(){
